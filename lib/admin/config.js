...
function massageCurrencies (currencies) {
  ...
  const top5Codes = ['MYR', 'USD', 'JPY', 'GBP', 'AUD']
...
const ALL_CRYPTOS = ['BTC', 'ETH', 'LTC', 'DASH', 'ZEC', 'BCH', 'DOGE']
  ...
  return machineLoader.getMachineNames()
    .then(machineList => ({
      ...
      accounts: [
        ...
        {code: 'mock-zero-conf', display: 'Mock 0-conf', class: 'zeroConf', cryptos: ['BTC', 'ZEC', 'LTC', 'DASH', 'BCH', 'ETH', 'DOGE']},
        {code: 'colony.pinkexc', display: 'Colony', class: 'wallet', cryptos: ['BTC', 'LTC', 'DASH', 'BCH', 'ETH', 'DOGE']},
      ],
